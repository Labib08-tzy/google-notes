...
<head>
    ...
    <title>Too Many Requests - Google Notes</title>
    <!-- Fonts -->
...
<body class="font-sans antialiased bg-[#F8F9FA] text-[#202124]">
    <div class="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        <!-- Icon -->
        <div class="w-24 h-24 bg-[#EA4335]/10 text-[#EA4335] rounded-3xl flex items-center justify-center mb-8 mx-auto animate-bounce">
        ...
        <!-- Heading -->
        <h1 class="text-6xl font-extrabold text-[#EA4335] mb-3">429</h1>
        <h2 class="text-2xl font-bold text-[#202124] mb-4">Too Many Requests</h2>
        <p class="text-gray-500 text-sm max-w-md mx-auto mb-8 leading-relaxed">
            You are sending too many requests to our servers. Please slow down and try again shortly.
        </p>
