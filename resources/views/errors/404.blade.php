...
<head>
    ...
    <title>Page Not Found - Google Notes</title>
    <!-- Fonts -->
...
<body class="font-sans antialiased bg-[#F8F9FA] text-[#202124]">
    <div class="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        <!-- Icon -->
        <div class="w-24 h-24 bg-[#4285F4]/10 text-[#4285F4] rounded-3xl flex items-center justify-center mb-8 mx-auto animate-bounce">
        ...
        <!-- Heading -->
        <h1 class="text-6xl font-extrabold text-[#4285F4] mb-3">404</h1>
        <h2 class="text-2xl font-bold text-[#202124] mb-4">Page Not Found</h2>
